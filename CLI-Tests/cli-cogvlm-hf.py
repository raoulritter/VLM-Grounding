...
# this example is based off of https://huggingface.co/THUDM/cogvlm-grounding-generalist-hf 
"""
...
while True:
    image_url = "http://images.cocodataset.org/val2017/000000039769.jpg" #This is where we will feed the images
    ...
    while True:
        # query = input("Human:")
        query = "What is the cat doing?" #Here we will feed the text
        print(query)
        if query == "clear":
            break
