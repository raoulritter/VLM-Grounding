...
def main():
    ...
    parser.add_argument('--output_file', type=str, default='output/coco/ans_files/coco_pope_popular_10_cogvlm_ans.json', help='Path to the output JSON file for storing answers')
