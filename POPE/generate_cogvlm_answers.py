...
def main():
    ...
    parser.add_argument('--input_file', type=str, default='output/coco/coco_box.json', help='Path to the input JSON file with questions and image names')
    parser.add_argument('--output_file', type=str, default='output/coco/ans_files/coco_box.json', help='Path to the output JSON file for storing answers')
    parser.add_argument("--image_dir", type=str, default='data/val2014/', help="Directory where images are stored")
    parser.add_argument("--from_pretrained", type=str, default="THUDM/cogvlm-grounding-generalist-hf", help="Model identifier for pretrained model")
